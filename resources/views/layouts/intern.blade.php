...
<head>
    ...
    <title>@yield('title', 'Intern Panel') | AI Internship Platform</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-user-name { font-size: 13px; font-weight: 500; color: #1a1a1a; }
        ...
        .topbar-title { font-size: 14px; font-weight: 500; letter-spacing: -0.01em; }
...
<div class="layout">
    ...
    <aside class="sidebar">
        <div class="sidebar-brand">
            ...
            <div class="sidebar-brand-sub">Intern Panel</div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section-label" style="margin-top:8px;">Work</div>
    ...
    <div class="main-col">
        <header class="topbar">
            ...
            <span class="topbar-meta">Intern Panel</span>
        </header>
